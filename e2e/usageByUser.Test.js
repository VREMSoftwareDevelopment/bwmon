describe('bwmon e2e usage by user, ', function() {
	...
	describe('data tab ', function() {
		...
		it('should have data table', function() {
			...
			expect(tableElement.first().getText()).toEqual('1 192.168.1.10 00:1C:25:27:9B:AE COMPUTER-3 15.004 0.973 15.978 18.3% 0.533 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
			expect(tableElement.last().getText()).toEqual('15 192.168.1.20 00:1A:E9:92:A5:5F COMPUTER-8 0.023 0.000 0.024 0.0% 0.001 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
		...
		it('should sort by IP', function() {
			...
			expect(tableElement.first().getText()).toEqual('1 192.168.2.146 0C:EE:E6:80:C8:8C COMPUTER-27 0.573 0.025 0.597 0.7% 0.020 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
			expect(tableElement.last().getText()).toEqual('15 192.168.1.15 00:1A:A0:C7:19:08 COMPUTER-9 27.175 0.565 27.740 31.8% 0.925 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
		});

		it('should sort by MAC', function() {
			var tableElement = element.all(by.repeater('current in usageByUserCtrl.data | orderBy:usageByUserCtrl.predicate:usageByUserCtrl.descending | itemsPerPage:usageByUserCtrl.pageSize'));
			element(by.id('MACSort')).click();
			expect(tableElement.first().getText()).toEqual('1 192.168.1.133 00:19:B9:03:00:D7 COMPUTER-22 0.006 0.000 0.006 0.0% 0.000 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
			expect(tableElement.last().getText()).toEqual('15 192.168.1.16 00:90:A9:C6:19:5B COMPUTER-11 0.055 0.001 0.056 0.1% 0.002 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
		});

		it('should sort by USER', function() {
			var tableElement = element.all(by.repeater('current in usageByUserCtrl.data | orderBy:usageByUserCtrl.predicate:usageByUserCtrl.descending | itemsPerPage:usageByUserCtrl.pageSize'));
			element(by.id('userSort')).click();
			expect(tableElement.first().getText()).toEqual('1 192.168.1.14 00:24:8D:28:F2:9A COMPUTER-1 0.203 0.012 0.214 0.2% 0.007 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
			expect(tableElement.last().getText()).toEqual('15 192.168.1.133 00:19:B9:03:00:D7 COMPUTER-22 0.006 0.000 0.006 0.0% 0.000 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
		});

		it('should sort by total', function() {
			var tableElement = element.all(by.repeater('current in usageByUserCtrl.data | orderBy:usageByUserCtrl.predicate:usageByUserCtrl.descending | itemsPerPage:usageByUserCtrl.pageSize'));
			element(by.id('totalSort')).click();
			expect(tableElement.first().getText()).toEqual('1 192.168.1.28 94:EB:CD:3D:82:CD COMPUTER-14 0.000 0.000 0.000 0.0% 0.000 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
			expect(tableElement.last().getText()).toEqual('15 192.168.1.140 00:1A:A0:C7:2D:EE COMPUTER-17 0.389 0.008 0.397 0.5% 0.013 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
		});
		...
		it('should show different information when changing year', function() {
			...
			expect(tableElement.first().getText()).toEqual('1 192.168.1.10 00:1C:25:27:9B:AE COMPUTER-3 12.806 1.016 13.822 57.9% 0.446 31 Dec 1, 2011 11:30:02 AM Dec 31, 2011 11:30:01 PM');
			expect(tableElement.last().getText()).toEqual('7 192.168.1.25 70:D4:F2:DA:FA:C9 COMPUTER-15 0.863 0.018 0.881 3.7% 0.088 10 Dec 21, 2011 8:00:01 PM Dec 31, 2011 12:30:01 PM');
		...
		it('should show different information when changing month', function() {
			...
			expect(tableElement.first().getText()).toEqual('1 192.168.1.10 00:1C:25:27:9B:AE COMPUTER-3 10.481 0.204 10.685 29.1% 0.356 30 Aug 1, 2013 7:30:02 PM Aug 30, 2013 11:00:07 PM');
			expect(tableElement.last().getText()).toEqual('9 192.168.1.27 10:D5:42:88:3F:A0 COMPUTER-16 0.853 0.066 0.919 2.5% 0.033 28 Aug 1, 2013 8:00:02 PM Aug 29, 2013 3:00:02 PM');
		...
		it('should show different information when changing user', function() {
			...
			expect(tableElement.first().getText()).toEqual('1 192.168.1.11 70:5A:B6:F3:58:AB COMPUTER-12 0.120 0.003 0.123 0.1% 0.004 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
			expect(tableElement.last().getText()).toEqual('5 192.168.1.16 00:90:A9:C6:19:5B COMPUTER-11 0.055 0.001 0.056 0.1% 0.002 30 Nov 1, 2013 4:30:01 PM Nov 30, 2013 10:30:02 PM');
			expect(element(by.css('tfoot')).getText()).toEqual('November 2013 Totals 83.066 4.263 87.329 2.911 30');
		});
	});
