...
describe('UsageByMonthGraph', () => {
    ...
    beforeEach(() => {
        vi.mocked(useUsageByMonthGraph).mockReturnValue(data);
    });
    ...
    it('renders loading state', () => {
        vi.mocked(useUsageByMonthGraph).mockReturnValue({ ...data, loading: true });
        renderComponent();
    ...
    it('displays correct graph options and series', () => {
        vi.mocked(useUsageByMonthGraph).mockReturnValue({
            ...data,
