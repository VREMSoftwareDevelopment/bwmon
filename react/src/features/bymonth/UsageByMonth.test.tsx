...
describe('UsageByMonth', () => {
    const data = {
        ...
        data: {
            ...
            total: { id: 2021, download: 300000, upload: 60000, total: 360000, average: 15000, days: 30 },
        },
        loading: false,
        error: null,
    };
    ...
    beforeEach(() => {
        vi.mocked(useUsageByMonth).mockReturnValue(data);
    ...
    it('renders loading state', () => {
        vi.mocked(useUsageByMonth).mockReturnValue({ ...data, data: undefined, loading: true });
        renderComponent();
    ...
    it('renders error state', () => {
        vi.mocked(useUsageByMonth).mockReturnValue({ ...data, data: undefined, loading: false, error: 'Failed to load data' });
        renderComponent();
