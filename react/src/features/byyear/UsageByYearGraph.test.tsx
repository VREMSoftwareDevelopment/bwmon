...
describe('UsageByYearGraph', () => {
    ...
    beforeEach(() => {
        vi.mocked(useUsageByYearGraph).mockReturnValue(data);
    });
    ...
    it('renders loading state', () => {
        vi.mocked(useUsageByYearGraph).mockReturnValue({ ...data, loading: true });
        renderComponent();
    ...
    it('displays correct graph options and series', () => {
        vi.mocked(useUsageByYearGraph).mockReturnValue({
            ...data,
