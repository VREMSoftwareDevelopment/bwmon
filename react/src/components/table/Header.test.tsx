...
type Row = { name: string; age: number; location: string };
...
describe('Header Suite', () => {
    ...
    describe('Header', () => {
        const cellInfos = [
            new CellInfo<Row>('name', true, 'left', 'Name', false),
            new CellInfo<Row>('age', true, 'right', 'Age', false),
            new CellInfo<Row>('location', false, 'left', 'Location', false),
        ];

        const defaultProps: HeaderProps<Row> = {
            prefix: 'test',
            cellInfos,
        ...
        const renderComponent = (props: HeaderProps<Row> = defaultProps) => {
            return render(
                <table>
                    <Header {...props} />
                </table>
        ...
        it('calls onRequestSort when sortable cell is clicked', () => {
            renderComponent();
            const nameSortLabel = within(screen.getByTestId('test-name')).getByRole('button');
    ...
    describe('Cell', () => {
        const cellInfo = new CellInfo<Row>('name', false, 'left', 'Name', false);
    ...
    describe('SortableCell', () => {
        const cellInfo = new CellInfo<Row>('name', true, 'left', 'Name', false);
        ...
        const renderComponent = (props: typeof ascendingProps) => {
            return render(
                <table>
                    <tbody>
                        <tr>
