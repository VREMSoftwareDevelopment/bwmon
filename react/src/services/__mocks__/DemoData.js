...
const loadData = () => {
    ...
    data.push(
        new Data(i++, '2011-06', '192.168.1.24', '00:27:10:0E:B5:60', 'COMPUTER-4', 19688956, 1620721, 1307160300, 1309491002)
    );
    ...
    data.push(
        new Data(i++, '2011-07', '192.168.1.24', '00:27:10:0E:B5:60', 'COMPUTER-4', 11856119, 761399, 1309492802, 1311602401)
    );
    ...
    data.push(
        new Data(i++, '2011-08', '192.168.1.24', '00:27:10:0E:B5:60', 'COMPUTER-4', 18193236, 937760, 1312304401, 1314840605)
    );
    ...
    data.push(
        new Data(i++, '2011-12', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 12805542, 1015988, 1322757002, 1325392201)
    );
    ...
    data.push(
        new Data(i++, '2012-01', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 1611469, 421499, 1327950001, 1328067001)
    );
    data.push(
        new Data(i++, '2012-01', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 15976972, 1251929, 1325394001, 1328067002)
    );
    ...
    data.push(
        new Data(i++, '2012-02', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 15380173, 1390972, 1328103001, 1330576202)
    );
    ...
    data.push(
        new Data(i++, '2012-03', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 11772728, 1151192, 1330578002, 1333251007)
    );
    data.push(new Data(i++, '2012-03', '192.168.1.21', '00:23:7A:F7:A0:D0', 'COMPUTER-2', 3308, 734, 1330579802, 1333251007));
    data.push(
        new Data(i++, '2012-04', '192.168.1.117', '00:19:B9:47:A2:1B', 'COMPUTER-24', 1589462, 35947, 1334187002, 1334239201)
    );
    ...
    data.push(
        new Data(i++, '2012-04', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 14617990, 1127896, 1333252802, 1335839402)
    );
    ...
    data.push(
        new Data(i++, '2012-05', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 10060254, 770012, 1335913201, 1338516001)
    );
    ...
    data.push(
        new Data(i++, '2012-06', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 7791216, 653809, 1338579001, 1341064801)
    );
    ...
    data.push(
        new Data(i++, '2012-07', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 18941401, 1044723, 1341275401, 1343575802)
    );
    ...
    data.push(
        new Data(i++, '2012-08', '192.168.1.22', '90:4C:E5:A6:91:FA', 'COMPUTER-6', 19588305, 785233, 1343827802, 1346463001)
    );
    data.push(new Data(i++, '2012-08', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 2473603, 78619, 1343921402, 1346463001));
    data.push(
        new Data(i++, '2012-08', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 8286899, 834773, 1344042001, 1346468401)
    );
    data.push(
        new Data(i++, '2012-09', '192.168.1.22', '90:4C:E5:A6:91:FA', 'COMPUTER-6', 11147836, 296972, 1346504402, 1347805807)
    );
    data.push(new Data(i++, '2012-09', '192.168.1.16', '00:90:A9:C6:19:5B', 'COMPUTER-11', 162115, 5812, 1346704202, 1348956002));
    data.push(
        new Data(i++, '2012-09', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 19822151, 568141, 1347807607, 1349037002)
    );
    data.push(new Data(i++, '2012-09', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 7996314, 474796, 1346542201, 1349038802));
    data.push(
        new Data(i++, '2012-09', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 17997682, 1745214, 1346524201, 1349040601)
    );
    data.push(
        new Data(i++, '2012-09', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 6854083, 184868, 1346545801, 1349051401)
    );
    ...
    data.push(
        new Data(i++, '2012-10', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 13669884, 379264, 1349132402, 1351310401)
    );
    data.push(
        new Data(i++, '2012-10', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 14055389, 311756, 1349175601, 1351366201)
    );
    data.push(new Data(i++, '2012-10', '192.168.1.21', 'A8:6A:6F:F2:AB:03', 'COMPUTER-2', 49751, 2279, 1350761402, 1351434601));
    data.push(
        new Data(i++, '2012-10', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 10500917, 1346529, 1349092802, 1351634402)
    );
    data.push(
        new Data(i++, '2012-10', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 10168370, 711676, 1349199001, 1351733402)
    );
    ...
    data.push(
        new Data(i++, '2012-11', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 11915310, 222607, 1352044802, 1353877202)
    );
    data.push(
        new Data(i++, '2012-11', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 22806445, 609045, 1351801801, 1354327202)
    );
    data.push(
        new Data(i++, '2012-11', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 10698006, 325315, 1351897201, 1354336202)
    );
    data.push(new Data(i++, '2012-11', '192.168.1.21', 'A8:6A:6F:F2:AB:03', 'COMPUTER-2', 9529, 1038, 1351895401, 1354336207));
    data.push(
        new Data(i++, '2012-11', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 11729779, 1072077, 1351801801, 1354336207)
    );
    ...
    data.push(
        new Data(i++, '2012-12', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 25659988, 408417, 1354374002, 1356987601)
    );
    data.push(
        new Data(i++, '2012-12', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 13800660, 353384, 1354420802, 1357005602)
    );
    data.push(new Data(i++, '2012-12', '192.168.1.21', 'A8:6A:6F:F2:AB:03', 'COMPUTER-2', 14029, 1061, 1354338002, 1357009201));
    data.push(
        new Data(i++, '2012-12', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 19534507, 1936772, 1354384802, 1357014602)
    );
    ...
    data.push(
        new Data(i++, '2013-01', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 15209487, 291107, 1357050602, 1359682202)
    );
    data.push(
        new Data(i++, '2013-01', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 26160244, 3258263, 1357065001, 1359682202)
    );
    data.push(
        new Data(i++, '2013-01', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 15284119, 317085, 1357021802, 1359684001)
    );
    data.push(
        new Data(i++, '2013-01', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 7172351, 227303, 1357056001, 1359693002)
    );
    data.push(
        new Data(i++, '2013-02', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 15596141, 376211, 1359813601, 1362013201)
    );
    ...
    data.push(
        new Data(i++, '2013-02', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 20786745, 2310726, 1359743401, 1362108607)
    );
    data.push(
        new Data(i++, '2013-02', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 8254872, 236240, 1359761402, 1362110407)
    );
    ...
    data.push(
        new Data(i++, '2013-03', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 20064665, 623125, 1362236402, 1364767202)
    );
    data.push(
        new Data(i++, '2013-03', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 22974934, 4278367, 1362141002, 1364770802)
    );
    data.push(new Data(i++, '2013-03', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 5092582, 141958, 1362258002, 1364772602));
    data.push(
        new Data(i++, '2013-03', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 7518625, 242570, 1362180607, 1364774402)
    );
    ...
    data.push(
        new Data(i++, '2013-04', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 13244733, 303083, 1364828407, 1367190004)
    );
    ...
    data.push(
        new Data(i++, '2013-04', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 15273323, 259911, 1364821202, 1367366401)
    );
    data.push(
        new Data(i++, '2013-04', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 11025970, 851535, 1364860801, 1367371807)
    );
    data.push(
        new Data(i++, '2013-04', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 14484352, 494283, 1364826607, 1367375401)
    );
    ...
    data.push(
        new Data(i++, '2013-05', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 13104897, 260709, 1367452802, 1370055601)
    );
    data.push(
        new Data(i++, '2013-05', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 12886070, 1619598, 1367526602, 1370055601)
    );
    data.push(
        new Data(i++, '2013-05', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 5967137, 176076, 1367451002, 1370057401)
    );
    ...
    data.push(
        new Data(i++, '2013-06', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 13523839, 260793, 1370176202, 1372476602)
    );
    data.push(new Data(i++, '2013-06', '192.168.1.26', '10:68:3F:47:A8:69', 'COMPUTER-13', 78724, 2847, 1370275201, 1372617002));
    data.push(
        new Data(i++, '2013-06', '192.168.1.15', '00:1A:A0:C7:19:08', 'COMPUTER-9', 13650687, 194603, 1371915002, 1372640402)
    );
    data.push(
        new Data(i++, '2013-06', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 10573371, 323212, 1370088002, 1372640402)
    );
    data.push(
        new Data(i++, '2013-06', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 17405070, 231891, 1370059201, 1372642202)
    );
    data.push(new Data(i++, '2013-06', '192.168.1.27', '10:D5:42:88:3F:A0', 'COMPUTER-16', 51336, 9259, 1372629602, 1372645807));
    data.push(
        new Data(i++, '2013-06', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 22834180, 4650779, 1370100604, 1372649402)
    );
    ...
    data.push(
        new Data(i++, '2013-07', '192.168.1.15', '00:1A:A0:C7:19:08', 'COMPUTER-9', 11773346, 258402, 1372698002, 1374960602)
    );
    data.push(
        new Data(i++, '2013-07', '192.168.1.25', '70:D4:F2:DA:FA:C9', 'COMPUTER-15', 11412500, 201098, 1372719601, 1375061401)
    );
    data.push(new Data(i++, '2013-07', '192.168.1.26', '10:68:3F:47:A8:69', 'COMPUTER-13', 36427, 2206, 1372694407, 1375230602));
    data.push(
        new Data(i++, '2013-07', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 8618099, 1033505, 1372651202, 1375236008)
    );
    data.push(new Data(i++, '2013-07', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 6267496, 133508, 1372692608, 1375311602));
    data.push(
        new Data(i++, '2013-07', '192.168.1.27', '10:D5:42:88:3F:A0', 'COMPUTER-16', 1394840, 162274, 1372692607, 1375313402)
    );
    ...
    data.push(
        new Data(i++, '2013-08', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 11025151, 1387270, 1375538402, 1377894601)
    );
    data.push(new Data(i++, '2013-08', '192.168.1.16', '00:90:A9:C6:19:5B', 'COMPUTER-11', 193814, 2336, 1375329602, 1377918002));
    data.push(
        new Data(i++, '2013-08', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 10480930, 203759, 1375399802, 1377918007)
    );
    ...
    data.push(
        new Data(i++, '2013-09', '192.168.1.27', '10:D5:42:88:3F:A0', 'COMPUTER-16', 1343921, 104747, 1378162801, 1379818807)
    );
    data.push(new Data(i++, '2013-09', '192.168.1.12', '00:26:9E:C4:A0:40', 'COMPUTER-5', 399551, 22406, 1378393202, 1380403802));
    data.push(
        new Data(i++, '2013-09', '192.168.1.15', '00:1A:A0:C7:19:08', 'COMPUTER-9', 14571888, 270336, 1378393207, 1380461402)
    );
    ...
    data.push(
        new Data(i++, '2013-09', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 18339058, 2556730, 1378216802, 1380596407)
    );
    ...
    data.push(
        new Data(i++, '2013-10', '192.168.1.15', '00:1A:A0:C7:19:08', 'COMPUTER-9', 20974237, 386715, 1380976201, 1382904002)
    );
    data.push(new Data(i++, '2013-10', '192.168.1.26', '10:68:3F:47:A8:69', 'COMPUTER-13', 76065, 4485, 1380641402, 1383188402));
    data.push(
        new Data(i++, '2013-10', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 17281773, 506644, 1380675602, 1383269402)
    );
    data.push(
        new Data(i++, '2013-10', '192.168.2.106', '10:D5:42:88:3F:A0', 'COMPUTER-29', 1442347, 106103, 1381003201, 1383269402)
    );
    ...
    data.push(
        new Data(i++, '2013-11', '192.168.2.106', '10:D5:42:88:3F:A0', 'COMPUTER-29', 1442347, 106103, 1383337801, 1385868602)
    );
    ...
    data.push(
        new Data(i++, '2013-11', '192.168.1.10', '00:1C:25:27:9B:AE', 'COMPUTER-3', 15004318, 973266, 1383337801, 1385868602)
    );
    ...
    data.push(
        new Data(i++, '2013-11', '192.168.1.15', '00:1A:A0:C7:19:08', 'COMPUTER-9', 27174976, 564783, 1383337801, 1385868602)
    );
    ...
    data.push(
        new Data(i++, '2013-11', '192.168.1.23', '78:E4:00:9F:97:3A', 'COMPUTER-10', 9291760, 324598, 1383337801, 1385868602)
    );
    data.push(
        new Data(i++, '2013-11', '192.168.1.24', '00:27:10:0E:B5:60', 'COMPUTER-4', 19688956, 1620721, 1383337801, 1385868602)
    );
